...
import { twoFAVerifyUseCase } from '../../application/useCases/TwoFAVerifyUseCase';
import AppHeader from '../../components/AppHeader';
import AppImage from '../../components/AppImage';
import AppText from '../../components/AppText';
import GradientText from '../../components/GradientText';
import { AppImages } from '../../constants';
import type { TwoFAVerifyScreenProps } from '../../navigation/types';
...
export default function TwoFAVerifyScreen({ navigation, route }: TwoFAVerifyScreenProps) {
  const theme = useTheme();
  const { preAuthToken, email } = route.params;
      ...
      <View style={styles.heroContainer}>
        ...
        <SafeAreaView edges={['top']} style={styles.heroInner}>
          ...
          <View style={styles.heroText}>
            <GradientText text="Two-Factor Verification" style={styles.heroTitle} />
