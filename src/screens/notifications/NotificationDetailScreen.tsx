    ...
    <SafeAreaView style={styles.screen} edges={['top', 'left', 'right']}>
      ...
      >
        ...
        <View style={styles.appointmentCard}>
          <AppText style={styles.appointmentCardTitle}>
            {t('notifications.appointmentDetails')}
          </AppText>

          <View style={styles.doctorRow}>
            <View style={styles.doctorAvatar}>
              <AppImage source={detail.doctor.avatar} containerStyle={{ width: 44, height: 44 }} />
            </View>
            <View>
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity style={styles.rescheduleBtn}>
          <AppText style={styles.rescheduleText}>{t('notifications.reschedule')}</AppText>
        </TouchableOpacity>
        <TouchableOpacity style={styles.confirmBtn}>
          <AppText style={styles.confirmText}>{t('notifications.confirm')}</AppText>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
